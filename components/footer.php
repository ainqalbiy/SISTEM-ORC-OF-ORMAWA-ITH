    ...
    <div class="footer-top">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <h4 class="footer-col-title"><i class="bi bi-geo-alt-fill"></i> Alamat</h4>
                <p>Kampus Institut Teknologi B.J Habibie<br>Parepare, Sulawesi Selatan</p>
            </div>

            <!-- Email & Telepon -->
            <div class="footer-col">
                <h4 class="footer-col-title"><i class="bi bi-envelope-fill"></i> Email</h4>
                <p><a href="mailto:orcormawa@ith.ac.id">orcormawa@ith.ac.id</a></p>
                <h4 class="footer-col-title mt-2"><i class="bi bi-telephone-fill"></i> Telepon</h4>
